...
class MobileNetV3(nn.Module):
    def __init__(self,
        ...
        self.last_channel = adjust_channels(1280 // reduce_divider)  # C5
        #last_channel = _make_divisible(ch=1280)
    ##########################################################
        ...
        layers.append(ConvBNActivation(lastconv_input_c,
                                       ...
                                       norm_layer=norm_layer,
                                       activation_layer=nn.Hardswish))
        # layers.append(ConvBNActivation(lastconv_output_c,
        #                                lastconv_output_c,
        #                                kernel_size=1,
        #                                norm_layer=norm_layer,
        #                                activation_layer=nn.Hardswish))
        ...
        self.classifier = nn.Sequential(nn.Linear(lastconv_output_c, self.last_channel),
...
def MobileNetV3_fpn_backbone(pretrain_path="",
    ...
    """
    MobileNetV3_backbome = MobileNetV3(weights_path=None)

    if isinstance(norm_layer, FrozenBatchNorm2d):
        overwrite_eps(MobileNetV3_backbome, 0.0)
