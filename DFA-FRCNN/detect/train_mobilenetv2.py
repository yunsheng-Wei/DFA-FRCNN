...
def create_model(num_classes):
    ...
    # net = MobileNetV2()
    backbone = MobileNetV2(weights_path="./weights/mobilenet_v2_pre.pth").features
    ...
    # torch.save(dict, "./weights/mobilev2.pth")
    return model
...
def main():
    ...
    VOC_root = "E:/"
    # check voc root
    if os.path.exists(os.path.join(VOC_root, "MyDataSet")) is False:
