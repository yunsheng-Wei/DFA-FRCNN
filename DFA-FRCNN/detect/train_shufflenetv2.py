...
from backbone import shufflenet_v2_x1_0
...
def create_model(num_classes):
    ...
    weights_dict = torch.load("weights/shufflenetv2_x1.pth")
    ...
    # first_layer = net.stem
    backbone = []
    backbone.append(net.conv1)
    backbone.append(net.maxpool)
    backbone.append(net.stage2)
    backbone.append(net.stage3)
    backbone.append(net.stage4)
    backbone.append(net.conv5)
    backbone = nn.Sequential(*backbone)
    # features = net.blocks
    # backbone = EfficientNetV2(weights_path="./weights/mobilenet_v2_pre.pth").features
    backbone.out_channels = 1024  # 设置对应backbone输出特征矩阵的channels
