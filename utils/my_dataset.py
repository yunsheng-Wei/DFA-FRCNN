...
class VOC2012DataSet(Dataset):
    ...
    def __init__(self, voc_root, transforms, txt_name: str = "train.txt"):
        self.root = os.path.join(voc_root, "MyDataSet", "Data2021")
    ...
    def __getitem__(self, idx):
        ...
        # img_path = os.path.join(self.img_root, data["filename"] + ".jpg")       # 训练自己的数据集时采用的代码， 没有.jpg后缀的情况
        # img_path = os.path.join(self.img_root, data["filename"])                  # 训练公共数据集采用的代码  原本读取图片路径的语句
        # 针对本数据集读取图片路径的语句
        # ===================================================================
        data["filename"] = xml_path.split("\\")[4].split(".")[0]
